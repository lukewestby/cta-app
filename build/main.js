...
var _user$project$Api$getBusRoutes = A2(
	_elm_lang$core$Task$mapError,
	_elm_lang$core$Basics$always('Couldn\'t fetch bus routes!'),
	A2(
		_elm_lang$core$Task$map,
		function (_) {
			return _.data;
...
var _user$project$Api$BusStop = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, latitude: c, longitude: d, direction: e};
	});
var _user$project$Api$busStopsReader = function (direction) {
	return _lukewestby$elm_http_builder$HttpBuilder$jsonReader(
		_elm_lang$core$Json_Decode$list(
			A2(
...
var _user$project$Api$getBusStops = F2(
		...
		return function (t) {
			...
			A2(
				...
				A2(
					...
					A3(
						_lukewestby$elm_http_builder$HttpBuilder$send,
						_user$project$Api$busStopsReader(direction),
						_lukewestby$elm_http_builder$HttpBuilder$stringReader,
						_lukewestby$elm_http_builder$HttpBuilder$get(
...
var _user$project$Api$getBusVehicles = function (routeId) {
	return A2(
		...
		_elm_lang$core$Basics$always(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'couldn\'t get vehicles for route ',
				A2(_elm_lang$core$Basics_ops['++'], routeId, '!'))),
		A2(
			_elm_lang$core$Task$map,
			function (_) {
				return _.data;
...
var _user$project$Api$directionDecoder = A2(
	_elm_lang$core$Json_Decode$customDecoder,
	_elm_lang$core$Json_Decode$string,
	function (value) {
		var _p1 = value;
...
var _user$project$Api$getBusRoute = function (id) {
	return A2(
		_elm_lang$core$Task$mapError,
		_elm_lang$core$Basics$always(
			A2(_elm_lang$core$Basics_ops['++'], 'Couldn\'t fetch bus route #', id)),
		A2(
			_elm_lang$core$Task$map,
			function (_) {
				return _.data;
...
var _user$project$Api$busPredictionsReader = _lukewestby$elm_http_builder$HttpBuilder$jsonReader(
	_elm_lang$core$Json_Decode$list(
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'isDelayed',
...
var _user$project$Api$getBusPredictions = function (stopId) {
	return A2(
		_elm_lang$core$Task$mapError,
		_elm_lang$core$Basics$always(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'couldn\'t fetch predictions for stop ',
				A2(_elm_lang$core$Basics_ops['++'], stopId, '!'))),
		A2(
			_elm_lang$core$Task$map,
			function (_) {
				return _.data;
...
var _user$project$BusRoute_Model$model = function (routeId) {
	return {routeData: _user$project$Utils$Initial, routeId: routeId, searchText: ''};
};
var _user$project$BusRoute_Model$RouteData = F3(
	function (a, b, c) {
		return {stops: a, route: b, selectedDirection: c};
	});
var _user$project$BusRoute_Model$Model = F3(
	function (a, b, c) {
		return {routeData: a, routeId: b, searchText: c};
	});

var _user$project$BusRoute_Update$loadRouteData = function (routeId) {
	var routeAndFirstToSecond = function (_p0) {
		var _p1 = _p0;
		var _p2 = _p1.route;
		return A2(
			_elm_lang$core$Task$map,
			function (sndStops) {
				return {
					route: _p2,
					stops: A2(_elm_lang$core$Basics_ops['++'], _p1.stops, sndStops),
					selectedDirection: _elm_lang$core$Basics$fst(_p2.directions)
				};
			},
			A2(
				_user$project$Api$getBusStops,
				_p2.id,
				_elm_lang$core$Basics$snd(_p2.directions)));
	};
	var routeToFirstDirection = function (route) {
		return A2(
			_elm_lang$core$Task$map,
			function (stops) {
			...
			A2(
				_user$project$Api$getBusStops,
				route.id,
				_elm_lang$core$Basics$fst(route.directions)));
	};
	return A2(
		_user$project$Utils$andThen,
		routeAndFirstToSecond,
		A2(
			_user$project$Utils$andThen,
			routeToFirstDirection,
			_user$project$Api$getBusRoute(routeId)));
};
var _user$project$BusRoute_Update$ClearSearchText = {ctor: 'ClearSearchText'};
var _user$project$BusRoute_Update$UpdateSearchText = function (a) {
	return {ctor: 'UpdateSearchText', _0: a};
};
var _user$project$BusRoute_Update$SelectDirection = function (a) {
	return {ctor: 'SelectDirection', _0: a};
};
var _user$project$BusRoute_Update$LoadRouteDataFinish = function (a) {
	return {ctor: 'LoadRouteDataFinish', _0: a};
};
var _user$project$BusRoute_Update$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'LoadRouteDataStart':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{routeData: _user$project$Utils$Loading}),
					_1: A2(
						_user$project$Utils$performSucceed,
						_user$project$BusRoute_Update$LoadRouteDataFinish,
						_user$project$BusRoute_Update$loadRouteData(model.routeId))
				};
			case 'LoadRouteDataFinish':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							routeData: _user$project$Utils$loadStateFromResult(_p3._0)
						}),
			...
			case 'SelectDirection':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							routeData: A2(
								_user$project$Utils$loadStateMap,
								function (data) {
									return _elm_lang$core$Native_Utils.update(
										data,
										{selectedDirection: _p3._0});
								},
								model.routeData)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$BusRoute_Update$LoadRouteDataStart = {ctor: 'LoadRouteDataStart'};
var _user$project$BusRoute_Update$initialize = _user$project$Utils$constant(_user$project$BusRoute_Update$LoadRouteDataStart);
...
var _user$project$Components_SearchBar$view = F3(
	function (inputValue, onType, onClear) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onInput(onType),
							_user$project$Components_SearchBar$class(
							_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[_user$project$Components_Classes$SearchIcon])),
							_elm_lang$html$Html_Events$onClick(onClear)
						]),
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$BusRoute_View$viewDirectionSelector = F2(
	function (selectedDirection, directions) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[_user$project$BusRoute_Classes$DirectionsSelector]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$BusRoute_View$classList(
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: _user$project$BusRoute_Classes$DirectionButton, _1: true},
									{
									ctor: '_Tuple2',
									_0: _user$project$BusRoute_Classes$ActiveDirectionButton,
									_1: _elm_lang$core$Native_Utils.eq(
										selectedDirection,
										_elm_lang$core$Basics$fst(directions))
								}
								])),
							_elm_lang$html$Html_Events$onClick(
							_user$project$BusRoute_Update$SelectDirection(
								_elm_lang$core$Basics$fst(directions)))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_1: _elm_lang$core$Native_Utils.eq(
										selectedDirection,
										_elm_lang$core$Basics$snd(directions))
								}
								])),
							_elm_lang$html$Html_Events$onClick(
							_user$project$BusRoute_Update$SelectDirection(
...
var _user$project$BusRoute_View$viewStop = function (summary) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$BusRoute_View$filterStops = F3(
	function (searchText, selectedDirection, stops) {
		return A2(
			_elm_lang$core$List$filter,
			function (stop) {
				return _elm_lang$core$Native_Utils.eq(stop.direction, selectedDirection) && A2(_elm_lang$core$String$contains, searchText, stop.name);
			},
			stops);
	});
var _user$project$BusRoute_View$viewSuccess = F2(
	function (searchText, routeData) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A3(_user$project$Components_SearchBar$view, searchText, _user$project$BusRoute_Update$UpdateSearchText, _user$project$BusRoute_Update$ClearSearchText),
							A2(_user$project$BusRoute_View$viewDirectionSelector, routeData.selectedDirection, routeData.route.directions)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$BusRoute_View$viewStop,
						A3(_user$project$BusRoute_View$filterStops, searchText, routeData.selectedDirection, routeData.stops)))
				]));
	});
var _user$project$BusRoute_View$view = function (model) {
	var _p1 = model.routeData;
	switch (_p1.ctor) {
		case 'Success':
			return A2(_user$project$BusRoute_View$viewSuccess, model.searchText, _p1._0);
		case 'Failure':
			return _elm_lang$html$Html$text('nope');
		default:
...
var _user$project$BusRoutes_Model$model = {routes: _user$project$Utils$Initial};
var _user$project$BusRoutes_Model$Model = function (a) {
	return {routes: a};
};
...
var _user$project$BusRoutes_Update$NoOp = {ctor: 'NoOp'};
var _user$project$BusRoutes_Update$NavigateTo = function (a) {
	return {ctor: 'NavigateTo', _0: a};
};
var _user$project$BusRoutes_Update$LoadRoutesFinish = function (a) {
	return {ctor: 'LoadRoutesFinish', _0: a};
};
var _user$project$BusRoutes_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'LoadRoutesStart':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{routes: _user$project$Utils$Loading}),
					_1: A2(_user$project$Utils$performSucceed, _user$project$BusRoutes_Update$LoadRoutesFinish, _user$project$Api$getBusRoutes)
				};
			case 'LoadRoutesFinish':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							routes: _user$project$Utils$loadStateFromResult(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NavigateTo':
...
var _user$project$BusRoutes_Update$LoadRoutesStart = {ctor: 'LoadRoutesStart'};
var _user$project$BusRoutes_Update$initialize = _user$project$Utils$constant(_user$project$BusRoutes_Update$LoadRoutesStart);
...
var _user$project$BusRoutes_View$viewSuccess = function (routes) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _user$project$BusRoutes_View$viewRoute, routes));
};
var _user$project$BusRoutes_View$view = function (model) {
	var _p1 = model.routes;
	switch (_p1.ctor) {
		case 'Success':
			return _user$project$BusRoutes_View$viewSuccess(_p1._0);
		case 'Failure':
			return _elm_lang$html$Html$text('nope');
		default:
			return _user$project$Components_Loading$view;
			...
			if (_p1.ctor === 'Success') {
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_p2.routeId,
						A2(_elm_lang$core$Basics_ops['++'], ' - ', _p1._0.route.name)));
			} else {
				return A2(_elm_lang$core$Basics_ops['++'], 'Route ', _p2.routeId);
			}
		default:
			return 'Not Found';
	}
	...
	function (msg, model) {
		...
		do {
			if (_p3.ctor === '_Tuple2') {
				switch (_p3._0.ctor) {
					case 'BusRouteMsg':
						if (_p3._1.ctor === 'BusRouteModel') {
							var _p4 = A2(_user$project$BusRoute_Update$update, _p3._0._0, _p3._1._0);
							var newModel = _p4._0;
							var subCmd = _p4._1;
							return {
								ctor: '_Tuple2',
					...
					case 'BusRoutesMsg':
						if (_p3._1.ctor === 'BusRoutesModel') {
							var _p5 = A2(_user$project$BusRoutes_Update$update, _p3._0._0, _p3._1._0);
							var newModel = _p5._0;
							var subCmd = _p5._1;
							return {
								ctor: '_Tuple2',
...
var _user$project$Routing$init = function (page) {
	var _p6 = page;
	switch (_p6.ctor) {
		case 'BusRoutesPage':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Routing$BusRoutesModel(_user$project$BusRoutes_Model$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Routing$BusRoutesMsg, _user$project$BusRoutes_Update$initialize)
			};
		case 'BusRoutePage':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Routing$BusRouteModel(
					_user$project$BusRoute_Model$model(_p6._0)),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Routing$BusRouteMsg, _user$project$BusRoute_Update$initialize)
			};
		default:
			return {ctor: '_Tuple2', _0: _user$project$Routing$NoneModel, _1: _elm_lang$core$Platform_Cmd$none};
	}
};
	...
	switch (_p7.ctor) {
		case 'BusRouteModel':
			return A2(
				...
				_user$project$BusRoute_View$view(_p7._0));
		case 'BusRoutesModel':
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Routing$BusRoutesMsg,
				_user$project$BusRoutes_View$view(_p7._0));
		default:
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {pageModel: a, currentPage: b};
	});
...
var _user$project$Main$init = function (page) {
	var _p1 = _user$project$Routing$init(page);
	var pageModel = _p1._0;
	var pageCmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: {pageModel: pageModel, currentPage: page},
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PageMsg, pageCmd)
	};
};
var _user$project$Main$urlUpdate = F2(
	function (page, model) {
		return _user$project$Main$init(page);
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'PageMsg') {
			var _p3 = A2(_user$project$Routing$update, _p2._0, model.pageModel);
			var pageModel = _p3._0;
			var pageCmd = _p3._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$Main$viewNavIcon, model.currentPage, _user$project$Pages$NotFound, _user$project$Icons$star),
						...
						A3(_user$project$Main$viewNavIcon, model.currentPage, _user$project$Pages$NotFound, _user$project$Icons$search)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_user$project$Routing$title(model.pageModel))
							])),
						A2(
						_elm_lang$html$Html_App$map,
						_user$project$Main$PageMsg,
						_user$project$Routing$view(model.pageModel))
					]))
			]));
};
